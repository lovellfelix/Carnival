...
"use strict";angular.module("pictures").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Pictures",state:"pictures",type:"dropdown"}),Menus.addSubMenuItem("topbar","pictures",{title:"List Pictures",state:"pictures.list"}),Menus.addSubMenuItem("topbar","pictures",{title:"Create Picture",state:"pictures.create"})}]);
...
"use strict";angular.module("tweets").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Tweets",state:"tweets",type:"dropdown"}),Menus.addSubMenuItem("topbar","tweets",{title:"List Tweets",state:"tweets.list"}),Menus.addSubMenuItem("topbar","tweets",{title:"Create Tweet",state:"tweets.create"})}]);
