...
"use strict";angular.module("core.admin").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Admin",state:"admin",icon:"settings",type:"dropdown",roles:["admin"]})}]);
...
"use strict";angular.module("pictures").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Pictures",state:"pictures.list",icon:"file-image",type:"dropdown"}),Menus.addSubMenuItem("topbar","pictures",{title:"List Pictures",state:"pictures.list"}),Menus.addSubMenuItem("topbar","pictures",{title:"Create Picture",state:"pictures.create"})}]);
...
"use strict";angular.module("tweets").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Tweets",state:"tweets.list",icon:"pound-box",type:"dropdown"}),Menus.addSubMenuItem("topbar","tweets",{title:"List Tweets",state:"tweets.list"}),Menus.addSubMenuItem("topbar","tweets",{title:"Create Tweet",state:"tweets.create"})}]);
...
"use strict";angular.module("videos").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Videos",isPublic:!0,state:"videos.slick",icon:"video",position:3})}]);
