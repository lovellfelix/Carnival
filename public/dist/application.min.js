"use strict";var ApplicationConfiguration=function(){var applicationModuleName="mean",applicationModuleVendorDependencies=["ngResource","ngAnimate","ngMessages","ui.router","ui.bootstrap","ui.utils","angularFileUpload","ui.gravatar","yaru22.angular-timeago","infinite-scroll","ngMaterial","bootstrapLightbox","dcbImgFallback","wu.masonry","ngSanitize","sc.twemoji"],registerModule=function(moduleName,dependencies){angular.module(moduleName,dependencies||[]),angular.module(applicationModuleName).requires.push(moduleName)};return{applicationModuleName:applicationModuleName,applicationModuleVendorDependencies:applicationModuleVendorDependencies,registerModule:registerModule}}();
...
"use strict";angular.module("posts").config(["LightboxProvider",function(LightboxProvider){LightboxProvider.templateUrl="modules/posts/client/views/view-post.client.view.html"}]);
