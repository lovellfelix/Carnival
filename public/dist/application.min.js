...
"use strict";angular.module("posts").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Stream",state:"stream",icon:"google-circles-extended",position:1,isPublic:!0}),Menus.addSubMenuItem("topbar","posts",{title:"List Posts",state:"posts.list"}),Menus.addSubMenuItem("topbar","posts",{title:"Create Post",state:"posts.create"})}]);
