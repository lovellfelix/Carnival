...
"use strict";angular.module("pictures").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Pictures",state:"pictures.list",icon:"file-image",type:"dropdown",isPublic:!0,position:2}),Menus.addSubMenuItem("topbar","pictures",{title:"List Pictures",state:"pictures.list",isPublic:!0}),Menus.addSubMenuItem("topbar","pictures",{title:"Create Picture",state:"pictures.create"})}]);
...
"use strict";angular.module("posts").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Posts",state:"posts.list",icon:"google-circles-extended",position:1,isPublic:!0}),Menus.addSubMenuItem("topbar","posts",{title:"List Posts",state:"posts.list"}),Menus.addSubMenuItem("topbar","posts",{title:"Create Post",state:"posts.create"})}]);
